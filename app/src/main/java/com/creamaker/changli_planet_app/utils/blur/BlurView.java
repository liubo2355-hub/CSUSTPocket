package com.creamaker.changli_planet_app.utils.blur;

import static com.creamaker.changli_planet_app.utils.blur.BlurController.DEFAULT_SCALE_FACTOR;
import static com.creamaker.changli_planet_app.utils.blur.PreDrawBlurController.TRANSPARENT;
...
public class BlurView extends FrameLayout {
     ...
     *                 BlurAlgorithm is automatically picked based on the API version.
     *                 It uses RenderEffect on API 31+, and RenderScriptBlur on older versions.
     *                 The  scale factor for view snapshot is used.
